...
// Identificadores
const char* ID        = "CRIE UM ID PARA O SEU GRUPO";
const char* moduleID  = "CRIE UM NOME PARA O MÓDULO";
...
// Tópico MQTT
#define TOPICO_PUBLISH  "esp32/2TDSPC"
